...
public class PlayerMovement : MonoBehaviour
{
	...
	public float Currentspeed;                //Player speed
	...
	void Crouch()
	{
		...
		transform.GetComponent<Animator>().SetBool("isCrouching", true);
	}
	...
	void StandUp()
	{
		...
		transform.GetComponent<Animator>().SetBool("isCrouching", false);
	}
